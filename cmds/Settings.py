...
class Settings(Cog_Extension):
    ...
    async def about(self,ctx):
        embed=discord.Embed(
        title="-----------------------------------------------------------------", 
        description="Bully Maguire is a chat bot which would make you down specifically when you are in seventh heaven", 
        color=0xaa1313,timestamp=datetime.datetime.utcnow())
        embed.set_author(
        name="Bully Maguire",
        url="https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjdxLPsu9H1AhVyIaYKHSrhBOwQFnoECBMQAQ&url=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FTobey_Maguire&usg=AOvVaw05QGRl8qoUZzMxwXjy5bos", 
        icon_url="https://pbs.twimg.com/profile_images/1399485270081380353/j3qja5r1_400x400.jpg")
